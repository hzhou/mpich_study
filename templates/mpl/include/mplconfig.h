...
#ifndef MPL_HAVE_MACH_ABSOLUTE_TIME 
#define MPL_HAVE_MACH_ABSOLUTE_TIME  1 
#endif
...
/* Define to an expression that will result in an error checking mutex type.
   */
#ifndef MPL_PTHREAD_MUTEX_ERRORCHECK_VALUE 
#define MPL_PTHREAD_MUTEX_ERRORCHECK_VALUE  PTHREAD_MUTEX_ERRORCHECK 
#endif
...
#ifndef MPL_TLS_SPECIFIER 
#define MPL_TLS_SPECIFIER  _Thread_local 
#endif
...
#ifndef MPL_USE_SCHED_YIELD_FOR_YIELD 
