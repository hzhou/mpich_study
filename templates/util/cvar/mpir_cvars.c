...
int MPIR_CVAR_CH4_SYMHEAP_RETRY = 100;
...
auto - Internal algorithm selection");
    ...
    MPIR_T_CVAR_REGISTER_STATIC(
        MPI_INT,
        MPIR_CVAR_CH4_SYMHEAP_RETRY, /* name */
        &MPIR_CVAR_CH4_SYMHEAP_RETRY, /* address */
        1, /* count */
        MPI_T_VERBOSITY_USER_BASIC,
        MPI_T_SCOPE_GROUP,
        defaultval,
        "CH4", /* category */
        "The default number of retries for allocating a symmetric heap in a process group. A retrying involves collective communication over the group.");
    rc = MPL_env2int("MPICH_CH4_SYMHEAP_RETRY", &(MPIR_CVAR_CH4_SYMHEAP_RETRY));
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_SYMHEAP_RETRY");
    rc = MPL_env2int("MPIR_PARAM_CH4_SYMHEAP_RETRY", &(MPIR_CVAR_CH4_SYMHEAP_RETRY));
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPIR_PARAM_CH4_SYMHEAP_RETRY");
    rc = MPL_env2int("MPIR_CVAR_CH4_SYMHEAP_RETRY", &(MPIR_CVAR_CH4_SYMHEAP_RETRY));
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPIR_CVAR_CH4_SYMHEAP_RETRY");
